       ...
       <!-- banner -->
       <div class="banner">
    <div class="w-100" style="max-height: 600px;">
        <img src="public\img\Artboard 2.png" class="w-100" alt="">
    </div>
</div>
<!-- search -->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 pb-5 col-lg-12 align-center">
                <h2 class="mbr-section-subtitle mbr-exbold mbr-light mbr-fonts-style display-5">Thực đơn</h2>
                <?php
                $rown = mysqli_fetch_array($data["name"]);
                ?>
                <h1 class="mbr-section-title pb-3 mbr-exbold mbr-fonts-style display-2" ><?php echo $rown['cate_name']?> của nhà hàng</h1>
            </div>
            <?php
            while ($row = mysqli_fetch_array($data["lsp_dm"])) {
        ?>
